...
class ContactGatlingTest extends Simulation {
    ...
    val scn = scenario("Test the Contact entity")
        ...
        .repeat(2) {
            ...
            .post("/api/contacts")
            .headers(headers_http_authenticated)
            .body(StringBody("""{"id":null, "contactId":"0", "companyId":"0", "siteId":"0", "lastName":"SAMPLE_TEXT", "firstName":"SAMPLE_TEXT", "title":"SAMPLE_TEXT", "email1":"SAMPLE_TEXT", "email2":"SAMPLE_TEXT", "phoneWork":"SAMPLE_TEXT", "phoneCell":"SAMPLE_TEXT", "phoneOther":"SAMPLE_TEXT", "address":"SAMPLE_TEXT", "city":"SAMPLE_TEXT", "state":"SAMPLE_TEXT", "zip":"SAMPLE_TEXT", "isHot":"0", "notes":"SAMPLE_TEXT", "enteredBy":"0", "owner":"0", "dateCreated":"2020-01-01T00:00:00.000Z", "dateModified":"2020-01-01T00:00:00.000Z", "leftCompany":"0", "importedId":"0", "companyDepartmentId":"0", "reportsTo":"0"}""")).asJSON
            .check(status.is(201))
