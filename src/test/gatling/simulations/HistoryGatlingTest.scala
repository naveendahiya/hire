...
class HistoryGatlingTest extends Simulation {
    ...
    val scn = scenario("Test the History entity")
        ...
        .repeat(2) {
            ...
            .post("/api/histories")
            .headers(headers_http_authenticated)
            .body(StringBody("""{"id":null, "historyId":"0", "dataItemType":"0", "dataItemId":"0", "theField":"SAMPLE_TEXT", "previousValue":"SAMPLE_TEXT", "newValue":"SAMPLE_TEXT", "description":"SAMPLE_TEXT", "setDate":"2020-01-01T00:00:00.000Z", "enteredBy":"0", "siteId":"0"}""")).asJSON
            .check(status.is(201))
