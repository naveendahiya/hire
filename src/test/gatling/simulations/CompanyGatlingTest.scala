...
class CompanyGatlingTest extends Simulation {
    ...
    val scn = scenario("Test the Company entity")
        ...
        .repeat(2) {
            ...
            .post("/api/companies")
            .headers(headers_http_authenticated)
            .body(StringBody("""{"id":null, "companyId":"0", "siteId":"0", "billingContact":"0", "name":"SAMPLE_TEXT", "address":"SAMPLE_TEXT", "city":"SAMPLE_TEXT", "state":"SAMPLE_TEXT", "zip":"SAMPLE_TEXT", "phone1":"SAMPLE_TEXT", "phone2":"SAMPLE_TEXT", "url":"SAMPLE_TEXT", "keyTechnologies":"SAMPLE_TEXT", "notes":"SAMPLE_TEXT", "enteredBy":"0", "owner":"0", "dateCreated":"2020-01-01T00:00:00.000Z", "dateModified":"2020-01-01T00:00:00.000Z", "isHot":"0", "faxNumber":"SAMPLE_TEXT", "importedId":"0", "defaultCompany":"0"}""")).asJSON
            .check(status.is(201))
