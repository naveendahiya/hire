...
class ActivityGatlingTest extends Simulation {
    ...
    val scn = scenario("Test the Activity entity")
        ...
        .repeat(2) {
            ...
            .post("/api/activities")
            .headers(headers_http_authenticated)
            .body(StringBody("""{"id":null, "activityId":"0", "dataItemId":"0", "dataItemType":"0", "joborderId":"0", "siteId":"0", "enteredBy":"0", "dateCreated":"2020-01-01T00:00:00.000Z", "type":"0", "notes":"SAMPLE_TEXT", "dateModified":"2020-01-01T00:00:00.000Z"}""")).asJSON
            .check(status.is(201))
