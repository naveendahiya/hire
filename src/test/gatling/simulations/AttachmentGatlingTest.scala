...
class AttachmentGatlingTest extends Simulation {
    ...
    val scn = scenario("Test the Attachment entity")
        ...
        .repeat(2) {
            ...
            .headers(headers_http_authenticated)
            .body(StringBody("""{"id":null, "attachmentId":"0", "dataItemId":"0", "dataItemType":"0", "siteId":"0", "title":"SAMPLE_TEXT", "originalFilename":"SAMPLE_TEXT", "storedFilename":"SAMPLE_TEXT", "contentType":"SAMPLE_TEXT", "resume":"0", "text":"SAMPLE_TEXT", "dateCreated":"2020-01-01T00:00:00.000Z", "dateModified":"2020-01-01T00:00:00.000Z", "profileImage":"0", "directoryName":"SAMPLE_TEXT", "md5Sum":"SAMPLE_TEXT", "fileSizeKb":"0", "md5SumText":"SAMPLE_TEXT"}""")).asJSON
            .check(status.is(201))
